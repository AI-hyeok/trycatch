...
class Play3 extends Phaser.Scene{
    ...
    preload(){
        this.background3 = this.load.image("background3","images/Play3.png");
        this.load.spritesheet('me', "images/캐릭터.png",{frameWidth:400/4, frameHeight:2000/20});
    }


    create(){
        let background = this.add.tileSprite(0,0,1740,1160,"background3");
        ...
        this.preventLines.forEach(preventLine => {
            ...
            this.physics.add.collider(this.me, preventLine, () => {
                ...
                if(this.gameTime < 1){
                    ...
                    this.score = (60 - this.gameTime/2)*2+20;
                }
